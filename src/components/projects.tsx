        ...
        <div id="projects" className="flex flex-col w-full px-[7.5%] my-[5vh] font-poppins ">
            ...
            <div className="flex flex-col w-full mt-[5vh] border border-[#262626] rounded-[1rem]">
                <div className="flex w-full max-1000:flex-col">
                    <div ref={textRef} className="w-full h-fit flex flex-col gap-4 px-9 pt-9 pb-4 border-r border-b border-[#262626] max-1000:border-r-0">
                        <div>
                    ...
                    <div ref={textRef} className="w-full h-fit flex flex-col gap-4 px-9 pt-9 pb-4 border-b border-[#262626]">
                        <div>
                ...
                <div className="flex w-full flex-wrap max-900:flex-col">
                    <div ref={textRef} className="w-[28%] h-fit flex flex-col gap-4 px-9 pt-9 pb-4 border-r border-[#262626] max-1000:border-r-0 max-900:w-full max-1500:w-[50%] max-1500:border-b">
                        <div>
                    ...
                    <div ref={textRef} className="w-[28%] h-fit flex flex-col gap-4 px-9 pt-9 pb-4 border-r border-[#262626]  max-1500:w-[50%] max-900:w-full max-1500:border-b  max-1500:border-r-0">
                        <div>
                            <Image src={"/images/imageFynan.png"} width={500} height={500} alt="Fynan una empresa de crypto" className="w-full rounded-[1.5rem] object-cover"></Image>
                        </div>
                        <div className="flex flex-col justify-between max-900:flex-row max-500:flex-col">
                    ...
                    <div ref={textRef} className="w-[28%] h-fit flex flex-col gap-4 px-9 pt-9 pb-4 border-r border-[#262626] max-1000:border-r-0 max-900:w-full max-1000:border-b max-1500:w-[50%]">
                        <div>
                            <Image src={"/images/imageFynan.png"} width={500} height={500} alt="Fynan una empresa de crypto" className="w-full rounded-[1.5rem] object-cover"></Image>
                        </div>
                        <div className="flex flex-col justify-between max-900:flex-row max-500:flex-col">
                    ...
                    <div ref={textRef} className="w-[16%] flex flex-col items-center justify-end max-900:w-full max-1500:w-[50%]">
                        <button className="group w-full p-2 transition-all ease-in-out duration-1000">
