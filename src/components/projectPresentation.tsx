...
export default function ProjectPresentation({title, tecnologies, presentation, linkWeb, srcImgPage}:{title:string, tecnologies:Array<string>, presentation:string, linkWeb:string, srcImgPage:string}) {
    ...
    return (
        <div className="w-full">
            ...
            <div className="my-[7.5vh] max-800:flex max-800:flex-col">
                ...
                <div ref={textRef} className="ml-auto w-1/2 h-full flex justify-between items-center px-[7.5%] my-2 font-poppins max-800:w-full">
                    <Image src={srcImgPage} width={500} height={400} alt="Fynan, empresa que se encarga de manejar la web3" className="w-full rounded-[1rem]"></Image>
                </div>
            </div>
