...
export default function Eclipso() {
    ...
    return (
        <ProjectPresentation 
            title="Nutri Scanner" 
            tecnologies={["HTML", "CSS", "JS", "GSAP", "Next.js", "React", "pdfjs-dist"]} 
            ...
            linkWeb="https://github.com/AgenciaDiffio/NutriScanner"
            srcImgPage="/images/nutriScannerCompletePage.png"
        >
        </ProjectPresentation>
    );
}
